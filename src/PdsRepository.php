...
class PdsRepository {
   ...
   *
   * @param \Drupal\pds_sync\AtprotoClient $atprotoClient
   *   The AT Protocol client.
  ...
  /**
   * Creates a feed record.
   *
   * @return mixed
   *   The response from the AT Protocol client.
   */
   ...
   *
   * @param array $pds_record
   *   The PDS record.
   *
   * @return array
   *   An array containing the reconciliation status.
   */
  ...
  /**
   * Creates a regular Bluesky post.
   *
   * @param \Drupal\node\NodeInterface $node
   *   The node to post.
   *
   ...
   *
   * @return array
   *   An array of syndication entities.
   */
   ...
   * @param array $replies
   *   The replies array.
   * @param array $wmValues
   *   The webmention values.
   */
  ...
  /**
   * Saves a webmention if it's new.
   *
   * @param array $values
   *   The webmention values.
   */
   ...
   *
   * @param string $text
   *   The text to create facets for.
   * @param array $tags
   *   The tags to create facets for.
   *
   * @return array
   *   An array of tag facets.
   */
